...
function _generateShapeFactorSimple(rightMember) {
  return Random$MathSolver.createEquation([Random$MathSolver.createProductExpression(undefined, [{
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createVarPrimitive("x", undefined)
  }, Random$MathSolver.createSumExpression([{
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createVarPrimitive("x", undefined)
    ...
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createIntPrimitive(rightMember)
  }]);
}

function _generateShapeFactorHard(rightMember) {
  return Random$MathSolver.createEquation([Random$MathSolver.createProductExpression(undefined, [Random$MathSolver.createSumExpression([{
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createVarPrimitive("x", undefined)
...
function _generateShapeSquare(rightMember) {
  return Random$MathSolver.createEquation([Random$MathSolver.createProductExpression(undefined, [{
    ...
    1,
    _0: Random$MathSolver.randomNumberPrimitive(undefined)
  }, Random$MathSolver.createPowerExpression(undefined, {
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createVarPrimitive("x", undefined)
    ...
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.createIntPrimitive(2)
  })]), {
    TAG:
    /* PrimitiveExpression */
    1,
...
function _generateShapeSquareConst(rightMember) {
  return Random$MathSolver.createEquation([Random$MathSolver.createSumExpression([Random$MathSolver.createProductExpression(undefined, [{
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.randomNumberPrimitive(undefined)
...
function _generateShapeSquareLinear(rightMember) {
  return Random$MathSolver.createEquation([Random$MathSolver.createSumExpression([Random$MathSolver.createProductExpression(undefined, [{
    ...
    1,
    _0: Random$MathSolver.createIntPrimitive(2)
  })]), Random$MathSolver.createProductExpression(undefined, [{
    TAG:
    /* PrimitiveExpression */
    1,
    _0: Random$MathSolver.randomNumberPrimitive(undefined)
...
},{"./Random.bs.js":12}],12:[function(require,module,exports){
"use strict";
...
exports.limit = exports.createEquation = exports.createRootExpression = exports.createSquarerootExpression = exports.createPowerExpression = exports.createConstFraction = exports.createVarFraction = exports.createProductExpression = exports.createSumExpression = exports.createIntPrimitive = exports.createintPrimitive = exports.createFloatPrimitive = exports.createVarPrimitive = exports.createTextExpression = exports.constFractionExpression = exports.varFractionExpression = exports.floatPrimitiveExpression = exports.intPrimitiveExpression = exports.varPrimitiveExpression = exports.toggleSign = void 0;
...
exports.createConstFraction = createConstFraction;
var createPowerExpression = Formula$MathSolver.createPowerExpression;
exports.createPowerExpression = createPowerExpression;
var createSquarerootExpression = Formula$MathSolver.createSquarerootExpression;
exports.createSquarerootExpression = createSquarerootExpression;
var createRootExpression = Formula$MathSolver.createRootExpression;
exports.createRootExpression = createRootExpression;
var createEquation = Formula$MathSolver.createEquation;
exports.createEquation = createEquation;
var limit = 12;
/* No side effect */

...
function createVarPrimitiveExpression(subscript, subscriptFontStyleOpt, variable) {
...
exports._cleanupSum = _cleanupSum;
exports._removeMultiplyOne = _removeMultiplyOne;
exports._cleanupProduct = _cleanupProduct;
...
function _cleanupSum(sum) {
  _removeAddZero(sum.terms);
...
function _cleanupProduct(product) {
  _removeMultiplyOne(product.factors);
...
function _cleanupExpression(expression) {
  switch (expression.TAG | 0) {
    ...
    /* SumExpression */
    5:
      var sum = expression._0;
      return {
        TAG:
        /* SumExpression */
        5,
        _0: (_removeAddZero(sum.terms), sum)
      };
    ...
    6:
      ...
      return {
        ...
        /* ProductExpression */
        6,
        _0: (_removeMultiplyOne(product.factors), product)
      };
...
function _cleanupEquation(equation) {
  equation.members.map(_cleanupExpression);
  return equation;
}
...
function cleanup(formula) {
  switch (formula.TAG | 0) {
    ...
    /* Equation */
    1:
      var equation = formula._0;
      return {
        TAG:
        /* Equation */
        1,
        _0: (equation.members.map(_cleanupExpression), equation)
      };
...
function _varPrimitiveNodeToTex(varPrimitive, signMode) {
  return _signAttrToTex(varPrimitive.sign, signMode) + _unicodeToTex(varPrimitive.primitive) + _subscriptAttrToTex(varPrimitive.subscript, varPrimitive.subscriptFontStyle);
}

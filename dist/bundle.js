...
function _subscriptAttrToTex(subscript, subscriptFontStyle) {
  if (subscript !== undefined) {
    return " _{ " + _applyFontStyle(subscript, subscriptFontStyle) + " } ";
  } else {
    return "";
  }
}
...
function _varPrimitiveNodeToTex(varPrimitive, signMode) {
  return _signAttrToTex(varPrimitive.sign, signMode) + _variableToTex(varPrimitive.primitive) + _subscriptAttrToTex(varPrimitive.subscript, varPrimitive.subscriptFontStyle);
}
